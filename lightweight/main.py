...
def getDatasetInParts(path, dataset='VERI-Wild'):
    """
    Args:
    ...
    if dataset == 'VERIWILD':
        ...
        data_g = trs.CustomDataSet4VERIWILD('/home/eurico/VERI-Wild/train_test_split/test_3000_id.txt', path+'/images/', transform=test_transform, with_view=False)
        data_train = trs.CustomDataSet4VERIWILD('/home/eurico/VERI-Wild/train_test_split/train_list.txt', path+'/images/', transform=train_transform, with_view=False)
